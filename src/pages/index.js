    ...
    <div className={styles.container}>
      ...
      >
        <div className="xl:max-w-screen-md">
          <div className="text-orange-light h-auto text-2xl font-black grid place-items-center hover:text-orange-dark md:text-4xl">
            KENGKEE.COM
          </div>
          <h1 className="text-center text-gray-800 font-black text-3xl mt-10 md:text-5xl lg:text-6xl md:mt-16">
            Do you want to get more done with less?
          </h1>
          <p className="text-sm md:text-base text-center text-gray-500 mt-10 md:mt-16">
          ...
          <div className="text-center mt-6 md:flex md:flex-row md:align-items-center md:justify-center md:mt-10">
            <input
              className="w-full border border-gray-300 p-2 box-border md:w-72 focus:outline-none focus:ring-2 focus:ring-orange-light"
              placeholder="Enter Your Email"
            />
            <button className="text-sm bg-orange-light text-white w-full font-bold p-3 box-border mt-3 focus:outline-none border-2 hover:bg-white hover:text-orange-light hover:border-orange-light md:mt-0 md:ml-3 md:w-48">
              YES, SEND IT TO ME!
            </button>
          </div>
        </div>
      ...
      <section className="w-screen p-10 md:p-20 lg:p-40">
        <div className="xl:max-w-screen-md mx-auto">
          ...
          <div className="mt-16 md:mt-24 md:w-3/4 md:m-auto">
            <div className="text-2xl text-center text-gray-700 font-bold">
              Need help in digital marketing and business operations?
            </div>
            <button className="text-sm bg-orange-light text-white w-full font-bold p-3 mt-6 focus:outline-none border-2 hover:bg-white hover:text-orange-light hover:border-orange-light">
              YES, LET'S DO IT!
            </button>
          </div>
        </div>
      ...
      >
        <div className="xl:max-w-screen-md mx-auto">
          ...
          <div className="mt-16 md:mt-24 md:w-3/4 md:m-auto">
            <div className="text-2xl text-center text-gray-700 font-bold">
              Find something that I could help?
            </div>
            <button className="text-sm bg-orange-light text-white w-full font-bold p-3 mt-6 focus:outline-none border-2 hover:bg-white hover:text-orange-light hover:border-orange-light">
              YES, LET'S EXPLORE!
            </button>
